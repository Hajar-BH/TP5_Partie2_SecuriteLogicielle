...
# direct methods
.method public static synthetic $r8$lambda$Tjr_4wextQdL65nrK9OAwU24iCo(ZLkotlin/jvm/functions/Function0;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0

    invoke-static/range {p0 .. p5}, Landroidx/activity/compose/BackHandlerKt;->BackHandler$lambda$8(ZLkotlin/jvm/functions/Function0;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$ZVjS7tGGZixCLTMQ6T2Xp6FzIlM(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Landroidx/compose/runtime/DisposableEffectScope;)Landroidx/compose/runtime/DisposableEffectResult;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/activity/compose/BackHandlerKt;->BackHandler$lambda$7$lambda$6(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Landroidx/compose/runtime/DisposableEffectScope;)Landroidx/compose/runtime/DisposableEffectResult;
...
.method public static synthetic $r8$lambda$cDlU4HhM7WAGr5BRR07rcLe9EcM(Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Z)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Landroidx/activity/compose/BackHandlerKt;->BackHandler$lambda$3$lambda$2(Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Z)Lkotlin/Unit;
...
.method public static final BackHandler(ZLkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V
    ...
    new-instance v12, Landroidx/activity/compose/BackHandlerKt$$ExternalSyntheticLambda0;

    invoke-direct {v12, v8, v6}, Landroidx/activity/compose/BackHandlerKt$$ExternalSyntheticLambda0;-><init>(Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Z)V
    ...
    invoke-static {v12, v4, v7}, Landroidx/compose/runtime/EffectsKt;->SideEffect(Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-direct {v3, v7, v13, v8}, Landroidx/activity/compose/BackHandlerKt$$ExternalSyntheticLambda1;-><init>(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;)V
    ...
    invoke-static {v13, v7, v3, v4, v9}, Landroidx/compose/runtime/EffectsKt;->DisposableEffect(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V
    ...
    .end local v13    # "lifecycleOwner":Landroidx/lifecycle/LifecycleOwner;
    ...
    new-instance v7, Landroidx/activity/compose/BackHandlerKt$$ExternalSyntheticLambda2;

    invoke-direct {v7, v6, v0, v1, v2}, Landroidx/activity/compose/BackHandlerKt$$ExternalSyntheticLambda2;-><init>(ZLkotlin/jvm/functions/Function0;II)V
...
.method private static final BackHandler$lambda$3$lambda$2(Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Z)Lkotlin/Unit;
    .locals 1
    .param p0, "$backCallback"    # Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;
    .param p1, "$enabled"    # Z

    .line 94
    invoke-virtual {p0, p1}, Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;->setEnabled(Z)V
...
.method private static final BackHandler$lambda$7$lambda$6(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;Landroidx/compose/runtime/DisposableEffectScope;)Landroidx/compose/runtime/DisposableEffectResult;
    .locals 3
    .param p0, "$backDispatcher"    # Landroidx/activity/OnBackPressedDispatcher;
    .param p1, "$lifecycleOwner"    # Landroidx/lifecycle/LifecycleOwner;
    .param p2, "$backCallback"    # Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;
    ...
    new-instance v2, Landroidx/activity/compose/BackHandlerKt$BackHandler$lambda$7$lambda$6$$inlined$onDispose$1;

    invoke-direct {v2, p2}, Landroidx/activity/compose/BackHandlerKt$BackHandler$lambda$7$lambda$6$$inlined$onDispose$1;-><init>(Landroidx/activity/compose/BackHandlerKt$BackHandler$backCallback$1$1;)V
...
.method private static final BackHandler$lambda$8(ZLkotlin/jvm/functions/Function0;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 1
