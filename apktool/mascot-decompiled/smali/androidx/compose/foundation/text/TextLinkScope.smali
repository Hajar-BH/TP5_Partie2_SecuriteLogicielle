...
.method public final LinksComposables(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v2, v1, Landroidx/compose/foundation/text/TextLinkScope;->text:Landroidx/compose/ui/text/AnnotatedString;
    ...
    invoke-virtual {v0, v11, v2}, Landroidx/compose/ui/text/AnnotatedString;->getLinkAnnotations(II)Ljava/util/List;

    move-result-object v12

    .line 157
    .local v12, "links":Ljava/util/List;
    move-object v13, v12
    ...
    .local v2, "range":Landroidx/compose/ui/text/AnnotatedString$Range;
    const/16 v17, 0x0
    ...
    .line 299
    .local v3, "it":Landroidx/compose/ui/graphics/Shape;
    const/4 v4, 0x0

    .line 159
    .local v4, "$i$a$-let-TextLinkScope$LinksComposables$1$clipModifier$1":I
    sget-object v5, Landroidx/compose/ui/Modifier;->Companion:Landroidx/compose/ui/Modifier$Companion;

    check-cast v5, Landroidx/compose/ui/Modifier;

    invoke-static {v5, v3}, Landroidx/compose/ui/draw/ClipKt;->clip(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/graphics/Shape;)Landroidx/compose/ui/Modifier;

    move-result-object v3

    .end local v3    # "it":Landroidx/compose/ui/graphics/Shape;
    .end local v4    # "$i$a$-let-TextLinkScope$LinksComposables$1$clipModifier$1":I
    if-nez v3, :cond_6
    ...
    .line 160
    .local v3, "clipModifier":Landroidx/compose/ui/Modifier;
    :cond_6
    const v4, -0x161d1965
    ...
    .line 160
    .local v11, "$i$a$-cache-TextLinkScope$LinksComposables$1$interactionSource$1":I
    invoke-static {}, Landroidx/compose/foundation/interaction/InteractionSourceKt;->MutableInteractionSource()Landroidx/compose/foundation/interaction/MutableInteractionSource;

    move-result-object v11

    .line 302
    .end local v11    # "$i$a$-cache-TextLinkScope$LinksComposables$1$interactionSource$1":I
    nop
    ...
    invoke-direct {v1, v3, v4, v8}, Landroidx/compose/foundation/text/TextLinkScope;->textRange(Landroidx/compose/ui/Modifier;II)Landroidx/compose/ui/Modifier;
    ...
    .local p1, "$dirty":I
    invoke-static {v4, v0, v11, v9, v8}, Landroidx/compose/foundation/HoverableKt;->hoverable$default(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;

    move-result-object v4

    .line 166
    sget-object v19, Landroidx/compose/ui/input/pointer/PointerIcon;->Companion:Landroidx/compose/ui/input/pointer/PointerIcon$Companion;

    move-object/from16 v24, v0

    .end local v0    # "interactionSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    .local v24, "interactionSource":Landroidx/compose/foundation/interaction/MutableInteractionSource;
    invoke-virtual/range {v19 .. v19}, Landroidx/compose/ui/input/pointer/PointerIcon$Companion;->getHand()Landroidx/compose/ui/input/pointer/PointerIcon;

    move-result-object v0

    invoke-static {v4, v0, v11, v9, v8}, Landroidx/compose/ui/input/pointer/PointerIconKt;->pointerHoverIcon$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/input/pointer/PointerIcon;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    invoke-direct {v0, v1, v2, v10}, Landroidx/compose/foundation/text/TextLinkScope$LinksComposables$1$1$1;-><init>(Landroidx/compose/foundation/text/TextLinkScope;Landroidx/compose/ui/text/AnnotatedString$Range;Landroidx/compose/ui/platform/UriHandler;)V
    ...
    invoke-static/range {v23 .. v34}, Landroidx/compose/foundation/ClickableKt;->combinedClickable-XVZzFYc$default(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/foundation/Indication;ZLjava/lang/String;Landroidx/compose/ui/semantics/Role;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;ILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    invoke-static {v0, v7, v4}, Landroidx/compose/foundation/interaction/HoverInteractionKt;->collectIsHoveredAsState(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v0

    .line 175
    .local v0, "isHovered$delegate":Landroidx/compose/runtime/State;
    move-object/from16 v8, v24

    check-cast v8, Landroidx/compose/foundation/interaction/InteractionSource;

    invoke-static {v8, v7, v4}, Landroidx/compose/foundation/interaction/FocusInteractionKt;->collectIsFocusedAsState(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v8

    .line 176
    .local v8, "isFocused$delegate":Landroidx/compose/runtime/State;
    move-object/from16 v9, v24

    check-cast v9, Landroidx/compose/foundation/interaction/InteractionSource;

    invoke-static {v9, v7, v4}, Landroidx/compose/foundation/interaction/PressInteractionKt;->collectIsPressedAsState(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;

    move-result-object v4

    .line 178
    .local v4, "isPressed$delegate":Landroidx/compose/runtime/State;
    nop
    ...
    .line 180
    invoke-static {v8}, Landroidx/compose/foundation/text/TextLinkScope;->LinksComposables$lambda$13$lambda$10(Landroidx/compose/runtime/State;)Z
    ...
    .line 181
    invoke-static {v4}, Landroidx/compose/foundation/text/TextLinkScope;->LinksComposables$lambda$13$lambda$11(Landroidx/compose/runtime/State;)Z
    ...
    invoke-virtual {v9}, Landroidx/compose/ui/text/LinkAnnotation;->getStyles()Landroidx/compose/ui/text/TextLinkStyles;

    move-result-object v9

    if-eqz v9, :cond_a

    invoke-virtual {v9}, Landroidx/compose/ui/text/TextLinkStyles;->getStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    invoke-virtual {v9}, Landroidx/compose/ui/text/TextLinkStyles;->getFocusedStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    invoke-virtual {v9}, Landroidx/compose/ui/text/TextLinkStyles;->getHoveredStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    invoke-virtual {v9}, Landroidx/compose/ui/text/TextLinkStyles;->getPressedStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    .end local v8    # "isFocused$delegate":Landroidx/compose/runtime/State;
    .local v20, "isFocused$delegate":Landroidx/compose/runtime/State;
    ...
    .end local v0    # "isHovered$delegate":Landroidx/compose/runtime/State;
    .local v25, "isHovered$delegate":Landroidx/compose/runtime/State;
    ...
    .line 313
    .end local v25    # "isHovered$delegate":Landroidx/compose/runtime/State;
    .restart local v0    # "isHovered$delegate":Landroidx/compose/runtime/State;
    :cond_f
    move-object/from16 v25, v0

    .line 314
    .end local v0    # "isHovered$delegate":Landroidx/compose/runtime/State;
    .restart local v25    # "isHovered$delegate":Landroidx/compose/runtime/State;
    :goto_a
    const/16 v23, 0x0

    .line 186
    .local v23, "$i$a$-cache-TextLinkScope$LinksComposables$1$2":I
    ...
    .local v3, "isFocused$delegate":Landroidx/compose/runtime/State;
    .local v4, "isHovered$delegate":Landroidx/compose/runtime/State;
    .local v5, "isPressed$delegate":Landroidx/compose/runtime/State;
    .local v8, "$this$cache$iv":Landroidx/compose/runtime/Composer;
    .local v20, "clipModifier":Landroidx/compose/ui/Modifier;
    ...
    .line 314
    .end local v23    # "$i$a$-cache-TextLinkScope$LinksComposables$1$2":I
    nop
    ...
    .line 178
    invoke-direct {v1, v9, v0, v7, v8}, Landroidx/compose/foundation/text/TextLinkScope;->StyleAnnotation([Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V

    .line 201
    nop

    .line 298
    .end local v2    # "range":Landroidx/compose/ui/text/AnnotatedString$Range;
    .end local v3    # "isFocused$delegate":Landroidx/compose/runtime/State;
    .end local v4    # "isHovered$delegate":Landroidx/compose/runtime/State;
    .end local v5    # "isPressed$delegate":Landroidx/compose/runtime/State;
    .end local v17    # "$i$a$-fastForEach-TextLinkScope$LinksComposables$1":I
    .end local v18    # "shape":Landroidx/compose/ui/graphics/Shape;
    .end local v20    # "clipModifier":Landroidx/compose/ui/Modifier;
    ...
    .end local v12    # "links":Ljava/util/List;
    :cond_11
    :goto_c
...
.method public final applyAnnotators$foundation_release()Landroidx/compose/ui/text/AnnotatedString;
    ...
    .local v2, "$this$applyAnnotators_u24lambda_u2415":Landroidx/compose/ui/text/AnnotatedString$Builder;
    const/4 v3, 0x0
    ...
    .line 319
    .end local v2    # "$this$applyAnnotators_u24lambda_u2415":Landroidx/compose/ui/text/AnnotatedString$Builder;
