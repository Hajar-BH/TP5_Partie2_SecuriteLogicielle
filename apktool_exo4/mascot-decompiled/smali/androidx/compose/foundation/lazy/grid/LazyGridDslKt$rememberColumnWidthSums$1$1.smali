...
.method public final invoke-0kLqBqw(Landroidx/compose/ui/unit/Density;J)Landroidx/compose/foundation/lazy/grid/LazyGridSlots;
    ...
    iget-object v1, p0, Landroidx/compose/foundation/lazy/grid/LazyGridDslKt$rememberColumnWidthSums$1$1;->$columns:Landroidx/compose/foundation/lazy/grid/GridCells;
    ...
    .line 162
    .local v2, "$i$a$-with-LazyGridDslKt$rememberColumnWidthSums$1$1$2":I
    nop
    ...
    .line 162
    invoke-interface {v1, p1, v5, v4}, Landroidx/compose/foundation/lazy/grid/GridCells;->calculateCrossAxisCellSizes(Landroidx/compose/ui/unit/Density;II)Ljava/util/List;
    ...
    .line 166
    .local v9, "$i$a$-let-LazyGridDslKt$rememberColumnWidthSums$1$1$2$1":I
    array-length v4, v6
    ...
    .line 168
    .local v10, "$i$a$-with-LazyGridDslKt$rememberColumnWidthSums$1$1$2$1$1":I
    ...
    .end local v10    # "$i$a$-with-LazyGridDslKt$rememberColumnWidthSums$1$1$2$1$1":I
    nop
    ...
    .end local v9    # "$i$a$-let-LazyGridDslKt$rememberColumnWidthSums$1$1$2$1":I
    nop

    .line 161
    .end local v1    # "$this$invoke_0kLqBqw_u24lambda_u243":Landroidx/compose/foundation/lazy/grid/GridCells;
    .end local v2    # "$i$a$-with-LazyGridDslKt$rememberColumnWidthSums$1$1$2":I
    return-object p1
    ...
    .line 156
    .local p1, "$i$a$-require-LazyGridDslKt$rememberColumnWidthSums$1$1$1":I
    nop

    .line 155
    .end local p1    # "$i$a$-require-LazyGridDslKt$rememberColumnWidthSums$1$1$1":I
