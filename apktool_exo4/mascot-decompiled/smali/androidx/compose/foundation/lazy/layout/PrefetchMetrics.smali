...
.method public final recordCompositionTiming$foundation_release(Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)V
    ...
    invoke-virtual {v3, p1, v6, v7}, Landroidx/collection/MutableObjectLongMap;->getOrDefault(Ljava/lang/Object;J)J
    ...
    .line 182
    .local v6, "currentAvgCompositionTimeNanos":J
    invoke-static {p0, v4, v5, v6, v7}, Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;->access$calculateAverageTime(Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;JJ)J
    ...
    .line 183
    .local v8, "newAvgCompositionTimeNanos":J
    invoke-virtual {p0}, Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;->getAverageCompositionTimeNanosByContentType()Landroidx/collection/MutableObjectLongMap;

    move-result-object v3

    invoke-virtual {v3, p1, v8, v9}, Landroidx/collection/MutableObjectLongMap;->set(Ljava/lang/Object;J)V
    ...
    .end local v6    # "currentAvgCompositionTimeNanos":J
    .end local v8    # "newAvgCompositionTimeNanos":J
    nop
    ...
    invoke-static {p0, v4, v5, v1, v2}, Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;->access$calculateAverageTime(Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;JJ)J
...
.method public final recordMeasureTiming$foundation_release(Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)V
    ...
    .line 198
    .local v6, "currentAvgMeasureTimeNanos":J
    invoke-static {p0, v4, v5, v6, v7}, Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;->access$calculateAverageTime(Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;JJ)J
    ...
    .line 199
    .local v8, "newAvgMeasureTimeNanos":J
    invoke-virtual {p0}, Landroidx/compose/foundation/lazy/layout/PrefetchMetrics;->getAverageMeasureTimeNanosByContentType()Landroidx/collection/MutableObjectLongMap;
    ...
    .end local v6    # "currentAvgMeasureTimeNanos":J
    .end local v8    # "newAvgMeasureTimeNanos":J
    nop
